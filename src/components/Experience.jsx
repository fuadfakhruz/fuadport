...
const Experience = () => {
  return (
    <div
      className="flex justify-center bg-slate-50 py-24 px-5 xl:px-0"
      id="experience"
    >
      <div className="w-[75rem]">
        <div className="flex flex-col justify-center items-center text-center">
          ...
          <p className="w-full sm:w-[35rem] leading-loose text-slate-500 text-lg">
            I am a Computer Engineering student at Diponegoro University. I also
            awarded as Bakti BCA Scholarship 2024 recipient.
          </p>
          <svg
            className="my-12"
            width="130"
        ...
        <div className="" id="list4">
          <div className="mx-4 sm:mx-2">
            <h1 className="text-3xl font-bold items-center justify-center px-6 md:px-60 text-slate-600">
              Experiences
            </h1>
            <div className="flex items-center py-10  px-8 md:px-64">
